...
export function AssetPreview() {
  const { assets, imageCodeFont } = useStealthDI();
  
  return (
    <div className="glass-panel high">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="asset-card">
          ...
          <img 
            src={assets.branding?.logo?.preview} 
            alt="Generated Logo"
        ...
        <div className="asset-card">
          ...
          <div className="flex gap-2 justify-center">
            {assets.favicons?.map((favicon, index) => (
        ...
        <div className="asset-card">
          ...
          <div className="flex gap-1 justify-center">
            {assets.branding?.color_palette?.map((color, index) => (
              <div
                key={index}
      ...
      <div className="mt-4 flex gap-2">
        <button 
          ...
          onClick={() => imageCodeFont.regenerateAssets()}
        >
          🔄 Regenerate Assets
        </button>
        <button 
          className="stealth-btn outline"
          onClick={() => imageCodeFont.downloadAssetPackage()}
        >
          📦 Download All
        </button>
      </div>
