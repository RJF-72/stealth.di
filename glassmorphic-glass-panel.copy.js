...
class GlassPanel {
    static create(options) {
        const panel = vscode.window.createWebviewPanel('codefont-studio', 'CodeFont Studio 🚀', vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    static getGlassmorphicHTML(panel) {
        return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
//# sourceMappingURL=glassmorphic-glass-panel.copy.js.map