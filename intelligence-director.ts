...
export class IntelligenceDirector {
    private directorPanel: vscode.WebviewPanel | undefined;
    private diModel: StealthDIModel;

    async openDirector(): Promise<void> {
        this.directorPanel = vscode.window.createWebviewPanel(
            'stealth-director',
            '🎯 Intelligence Director - Stealth.DI',
    ...
    private getDirectorHTML(): string {
        return `
        <!DOCTYPE html>
        <html>
        <head>
