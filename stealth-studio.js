...
class StealthStudio {
    ...
    async openStudio() {
        this.panel = vscode.window.createWebviewPanel('stealth-studio', '🕶️ Stealth.DI Studio', vscode.ViewColumn.One, {
            enableScripts: true,
...
exports.StealthStudio = StealthStudio;
//# sourceMappingURL=stealth-studio.js.map